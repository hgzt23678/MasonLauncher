...
const messages = {
  ...
  'nav.modpacks': { ja: 'ModPack', en: 'Modpacks', zhHant: '模組包', zhHans: '整合包', ko: '모드팩' },
  ...
  'modpacks.title': { ja: 'ModPackを探す', en: 'Discover modpacks', zhHant: '尋找模組包', zhHans: '查找整合包', ko: '모드팩 찾기' },
  'modpacks.description': { ja: 'Modrinthで公開されているModPackを検索します。', en: 'Search for modpacks published on Modrinth.', zhHant: '搜尋 Modrinth 上公開的模組包。', zhHans: '搜索 Modrinth 上发布的整合包。', ko: 'Modrinth에 공개된 모드팩을 검색합니다.' },
  'modpacks.searchPlaceholder': { ja: 'ModPack名を検索（空欄は人気順）', en: 'Search modpacks (leave blank for popular)', zhHant: '搜尋模組包（留空顯示熱門項目）', zhHans: '搜索整合包（留空显示热门项目）', ko: '모드팩 검색(비워 두면 인기순)' },
  'modpacks.search': { ja: '検索', en: 'Search', zhHant: '搜尋', zhHans: '搜索', ko: '검색' },
  'modpacks.searching': { ja: '検索中...', en: 'Searching...', zhHant: '搜尋中...', zhHans: '搜索中...', ko: '검색 중...' },
  'modpacks.loadingPopular': { ja: '人気のModPackを読み込んでいます...', en: 'Loading popular modpacks...', zhHant: '正在載入熱門模組包...', zhHans: '正在加载热门整合包...', ko: '인기 모드팩을 불러오는 중...' },
  'modpacks.popularTitle': { ja: '人気のModPack', en: 'Popular modpacks', zhHant: '熱門模組包', zhHans: '热门整合包', ko: '인기 모드팩' },
  'modpacks.searchResultsTitle': { ja: '検索結果', en: 'Search results', zhHant: '搜尋結果', zhHans: '搜索结果', ko: '검색 결과' },
  'modpacks.resultCount': { ja: '{count} 件', en: '{count} results', zhHant: '{count} 個結果', zhHans: '{count} 个结果', ko: '결과 {count}개' },
  'modpacks.install': { ja: 'インストール', en: 'Install', zhHant: '安裝', zhHans: '安装', ko: '설치' },
  'modpacks.installing': { ja: 'インストール中...', en: 'Installing...', zhHant: '正在安裝...', zhHans: '正在安装...', ko: '설치 중...' },
  'modpacks.installed': { ja: '{name}を新規プロファイルへインストールしました。', en: 'Installed {name} as a new profile.', zhHant: '已將 {name} 安裝為新的設定檔。', zhHans: '已将 {name} 安装为新的配置文件。', ko: '{name}을(를) 새 프로필로 설치했습니다.' },
  'modpacks.installFailed': { ja: 'ModPackのインストールに失敗しました。', en: 'Failed to install the modpack.', zhHant: '模組包安裝失敗。', zhHans: '整合包安装失败。', ko: '모드팩 설치에 실패했습니다.' },
  'modpacks.loadFailed': { ja: 'ModPackの取得に失敗しました。', en: 'Failed to load modpacks.', zhHant: '無法載入模組包。', zhHans: '无法加载整合包。', ko: '모드팩을 불러오지 못했습니다.' },
  'modpacks.noResults': { ja: '該当するModPackが見つかりませんでした。', en: 'No matching modpacks were found.', zhHant: '找不到符合的模組包。', zhHans: '未找到匹配的整合包。', ko: '일치하는 모드팩을 찾지 못했습니다.' },
  'modpacks.downloads': { ja: '{count} ダウンロード', en: '{count} downloads', zhHant: '{count} 次下載', zhHans: '{count} 次下载', ko: '{count}회 다운로드' },
  'modpacks.followers': { ja: '{count} フォロワー', en: '{count} followers', zhHant: '{count} 位追蹤者', zhHans: '{count} 位关注者', ko: '팔로워 {count}명' },
  ...
  'settings.developerMode': { ja: '開発者モード', en: 'Developer mode', zhHant: '開發者模式', zhHans: '开发者模式', ko: '개발자 모드' },
  'settings.developerModeDescription': { ja: '開発者設定と診断ログを表示します。', en: 'Show developer settings and diagnostic logs.', zhHant: '顯示開發者設定與診斷記錄。', zhHans: '显示开发者设置和诊断日志。', ko: '개발자 설정과 진단 로그를 표시합니다.' },
  'settings.developerSettings': { ja: '開発者設定', en: 'Developer settings', zhHant: '開發者設定', zhHans: '开发者设置', ko: '개발자 설정' },
  'settings.developerSettingsDescription': { ja: '開発者モード用の認証と表示テーマを設定します。', en: 'Configure authentication and appearance options for developer mode.', zhHant: '設定開發者模式的驗證與外觀選項。', zhHans: '配置开发者模式的身份验证和外观选项。', ko: '개발자 모드의 인증 및 표시 테마를 설정합니다.' },
  'settings.themeColor': { ja: 'Materialテーマカラー', en: 'Material theme color', zhHant: 'Material 主題色彩', zhHans: 'Material 主题颜色', ko: 'Material 테마 색상' },
  'settings.themeColorDescription': { ja: '6桁のHEXカラーをMaterial Webの主要色へ反映します。', en: 'Apply a six-digit HEX color to the Material Web primary color.', zhHant: '將六位數 HEX 色彩套用至 Material Web 主要色彩。', zhHans: '将六位 HEX 颜色应用到 Material Web 主色。', ko: '6자리 HEX 색상을 Material Web 기본 색상에 적용합니다.' },
  'settings.applyThemeColor': { ja: 'テーマカラーを保存', en: 'Save theme color', zhHant: '儲存主題色彩', zhHans: '保存主题颜色', ko: '테마 색상 저장' },
  'settings.themeColorSaved': { ja: 'テーマカラーを保存しました。', en: 'Theme color saved.', zhHant: '已儲存主題色彩。', zhHans: '已保存主题颜色。', ko: '테마 색상을 저장했습니다.' },
  'settings.themeColorInvalid': { ja: '#RRGGBB形式で入力してください。', en: 'Enter a color in #RRGGBB format.', zhHant: '請以 #RRGGBB 格式輸入色彩。', zhHans: '请以 #RRGGBB 格式输入颜色。', ko: '#RRGGBB 형식으로 입력하세요.' },
